...
echo "run 'python fpowertoolpath/tools/genPerfStp.py app.funcount  number'. The fucntions which run times is bigger than the number won't be processed. "
echo "run 'python $DIR/tools/genPerfStp.py app.funcount  number'. The fucntions which run times is bigger than the number won't be processed. "
fi
